...
const SmartCity = () => {
    return (
        <div className="lg:flex items-center  justify-center  px-[30px] py-[50px]"
            style={{ width: '100%', height: '', backgroundImage: 'url("/images/smartcity.png")', backgroundRepeat: "no-repeat" }}>
            <div className="relative lg:w-[440px] h-[550px]">
            ...
            <div>
                ...
                <p className="text-[16px] text-[] mt-3 font-[700] ml-1">Available on IOS & Android</p>
                <p className="text-[16px] text-[]  ml-1 max-w-[500px]">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</p>
