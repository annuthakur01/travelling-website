...
const RelatedTours = () => {
  return (
    ...
    <div className="flex flex-wrap  justify-center gap-10 lg:justify-between items-center p-16 ">
       
            <div className="font-[700] text-[36px] text-[#1C2B38]">Related tours in Today</div>
